...
// The only real trouble I encountered was the nested property of children with their own properties. Once I looked up the syntax and realized that you can simply chain properties with . seperation as long as they are valid variable names I was able to make the test pass. I also went back to the previous items and re-factored from adding variables with the more typical Ruby syntax of terah["spouse"] = to terah.spouse =
//How difficult was it to add and delete properties outside of the object itself?
// Very easy to add and delete properties outside of the object itself.
//What did you learn about manipulating objects in this challenge?
// That in Javascript its actually a bit easier to access nested objects than what we've been doing in Ruby.
//
//
//
//
